...
// =============================---==============
#ifndef __GPRDRSolver_ADERDG_Variables_CLASS_HEADER__
#define __GPRDRSolver_ADERDG_Variables_CLASS_HEADER__
 ...
 * specification file
 **/
struct GPRDR::AbstractGPRDRSolver_ADERDG::VariableMetrics {
  static constexpr int numDistinctVariables = 13;
  static constexpr int SizeVariables  = 27; 
  static constexpr int SizeParameters = 0;
  static constexpr int Size           = 27+0;
 ...
 **/
class GPRDR::AbstractGPRDRSolver_ADERDG::VariableShortcuts : public GPRDR::AbstractGPRDRSolver_ADERDG::VariableMetrics {
public:
  /// positions of fields inside the unknown vector (solution vector) Q
  const int _Q[numDistinctVariables + 1] = { 0,1,4,5,8,17,18,19,20,21,22,23,24 };
 ...
 **/
class GPRDR::AbstractGPRDRSolver_ADERDG::VariableMultiplicities : public GPRDR::AbstractGPRDRSolver_ADERDG::VariableMetrics {
public:
  /// positions of fields inside the unknown vector (solution vector) Q
 
  const int _Q[numDistinctVariables] = { 1,3,1,3,9,1,1,1,1,1,1,1,3 };
 ...
 *
 **/
class GPRDR::AbstractGPRDRSolver_ADERDG::VariableNames : public GPRDR::AbstractGPRDRSolver_ADERDG::VariableMetrics {
public:
  char const *_Q[numDistinctVariables + 1] = { "rho","v","s","J","A","alpha","lambda","mu","xi","xi1","sliding","sliding_xi","slip" };
 ...
 * 
 *    void somewhere() {
 *       using namespace GPRDR::GPRDRSolver_ADERDG_Variables::shortcuts;
 *       Q[foo] = 17;
 *    }
 *
 * instead of
 * 
 *    void somewhere() {
 *       GPRDR::AbstractGPRDRSolver_ADERDG::VariableNames q;
 *       Q[q.foo] = 17;
 *    }
 *
 **/
namespace GPRDR {
  namespace GPRDRSolver_ADERDG_Variables {
    namespace shortcuts {
      constexpr int rho = 0;
      constexpr int v = 1;
      constexpr int s = 4;
  ...
  } // end of namespace GPRDR::GPRDRSolver_ADERDG_Variables 
...
class GPRDR::AbstractGPRDRSolver_ADERDG::ReadOnlyVariables : public GPRDR::AbstractGPRDRSolver_ADERDG::VariableMetrics {
  private:
...
class GPRDR::AbstractGPRDRSolver_ADERDG::Variables : public GPRDR::AbstractGPRDRSolver_ADERDG::VariableMetrics{
  private:
    double* const _Q;
  public:
    static constexpr int SizeVariables  = 27;
...
class GPRDR::AbstractGPRDRSolver_ADERDG::Fluxes : public GPRDR::AbstractGPRDRSolver_ADERDG::VariableMetrics {
  private:
    double** const _F;
  public:
...
// Global Observables
//
class GPRDR::AbstractGPRDRSolver_ADERDG::ReadOnlyGlobalObservables {
  private:
...
class GPRDR::AbstractGPRDRSolver_ADERDG::GlobalObservables {
  private:
