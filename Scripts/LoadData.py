...
obvnodampvd = PVDReader(FileName='/import/freenas-m-05-seissol/dli/ExaHyPE/Obv/nodam/obv-nodam.pvd')
obvnodampvd.CellArrays = ['time', 'Q', 'RefinementStatus', 'PreviousRefinementStatus']
...
# save screenshot
SaveScreenshot('/import/freenas-m-05-seissol/dli/ExaHyPE/Obv/nodam-u.jpg', renderView1, ImageResolution=[1482, 799])
